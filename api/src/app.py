...
from api.src.residential_complex_management import (
    router as residential_complex_management,
)
...
from api.src.hot_jks import router as hot_jks_router
...
app.include_router(
    jk_rentals_router, prefix="/api/jks/rentals", tags=["jk-rentals-analysis"]
)
app.include_router(
    residential_complex_management, prefix="/api/complexes", tags=["complex-management"]
)
app.include_router(
    flat_management_router, prefix="/api/flats", tags=["flat-management"]
)
app.include_router(
...
app.include_router(hot_jks_router, prefix="/api/jks", tags=["hot-jks"])
