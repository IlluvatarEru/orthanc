...
from scraper_with_db import scrape_and_save, scrape_multiple_flats, get_database_summary, search_flats_in_db
...
def main():
    ...
    Main CLI function.
    """
    parser = argparse.ArgumentParser(description='Krisha.kz Scraper CLI Tool')
