...
def analyze_jk(complex_name, db_path='flats.db'):
    ...
    try:
        ...
        try:
            # Get rental flats
            rental_flats = db.get_flats_for_residential_complex(complex_name, 'rental')

            # Get sales flats
            sales_flats = db.get_flats_for_residential_complex(complex_name, 'sales')
...
def view_similar_flats(flat_type, complex_name, db_path='flats.db'):
    ...
    try:
        ...
        try:
            ...
            flats = db.get_flats_for_residential_complex(complex_name, flat_type)
