...
class TestSalesScraping:
    ...
    def test_scrape_sales_flat_with_failover_success_1(self):
        ...
        logger.info(f"Testing sales scraping with failover for Krisha ID: {TEST_SALES_KRISHA_ID_1}")
        logger.info(f"URL: https://krisha.kz/a/show/{TEST_SALES_KRISHA_ID_1}")

        flat_info = scrape_sales_flat_from_analytics_page_with_failover_to_sale_page(TEST_SALES_KRISHA_ID_1)

        # Fail if None
        assert flat_info is not None, "Failed to scrape sales flat with failover - returned None."
    ...
    def test_scrape_sales_flat_with_failover_success_2(self):
        ...
        logger.info(f"Testing sales scraping with failover for Krisha ID: {TEST_SALES_KRISHA_ID_2}")
        logger.info(f"URL: https://krisha.kz/a/show/{TEST_SALES_KRISHA_ID_2}")

        flat_info = scrape_sales_flat_from_analytics_page_with_failover_to_sale_page(TEST_SALES_KRISHA_ID_2)
    ...
    def test_scrape_sales_flat_from_sales_page_success_1(self):
        ...
        logger.info(f"Testing direct sales page scraping for Krisha ID: {TEST_SALES_KRISHA_ID_1}")
        logger.info(f"URL: https://krisha.kz/a/show/{TEST_SALES_KRISHA_ID_1}")

        flat_info = scrape_sales_flat_from_sale_page(TEST_SALES_KRISHA_ID_1)

        # Fail if None
        assert flat_info is not None, "Failed to scrape sales flat from sales page - returned None."
    ...
    def test_scrape_sales_flat_from_sales_page_success_2(self):
        ...
        logger.info(f"Testing direct sales page scraping for Krisha ID: {TEST_SALES_KRISHA_ID_2}")
        logger.info(f"URL: https://krisha.kz/a/show/{TEST_SALES_KRISHA_ID_2}")
