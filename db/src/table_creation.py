...
class DatabaseSchema:
    ...
    def create_indexes(self):
        ...
        self.conn.execute(
            "CREATE INDEX IF NOT EXISTS idx_rental_query_date ON rental_flats(query_date)"
        )
        self.conn.execute(
            "CREATE INDEX IF NOT EXISTS idx_rental_price ON rental_flats(price)"
        )
        self.conn.execute(
            "CREATE INDEX IF NOT EXISTS idx_rental_area ON rental_flats(area)"
        )
        ...
        self.conn.execute(
            "CREATE INDEX IF NOT EXISTS idx_sales_query_date ON sales_flats(query_date)"
        )
        self.conn.execute(
            "CREATE INDEX IF NOT EXISTS idx_sales_price ON sales_flats(price)"
        )
        self.conn.execute(
            "CREATE INDEX IF NOT EXISTS idx_sales_area ON sales_flats(area)"
        )
        ...
        self.conn.execute(
            "CREATE INDEX IF NOT EXISTS idx_favorites_type ON favorites(flat_type)"
        )
        ...
        self.conn.execute(
            "CREATE INDEX IF NOT EXISTS idx_blacklisted_krisha_id ON blacklisted_jks(krisha_id)"
        )
        self.conn.execute(
