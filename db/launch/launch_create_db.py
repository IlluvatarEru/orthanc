...
Examples:
  ...
  python -m db.launch.launch_create_db --force --sample-data
    ...
    if os.path.exists(args.db_path) and not args.force and not args.verify_only:
        ...
        logger.info("Use --force to recreate or --verify-only to check existing database")
        return
    ...
    logger.info("You can now run scraping operations and use the blacklist management tools.")
